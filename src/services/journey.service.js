...
export const journeyService = {
  ...
  update:               (id, payload)  => api.put(`/revp/journey/${encodeURIComponent(id)}/update/`, payload),
  delete:               (id)           => api.delete(`/revp/journey/${encodeURIComponent(id)}/delete/`),
  getQuestionAtOptions: ()             => api.get('/revp/journey/question-at/'),
}
