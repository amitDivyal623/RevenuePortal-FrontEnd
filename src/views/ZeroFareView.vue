<template>
  <AppLayout>
    ...
    <div class="card card-padded">
      <div class="card-title">Zero Fare Toggles</div>
    ...
    <AdminModal v-if="modalOpen" title="Edit Zero Fare Control" size="md" mode="edit" @close="modalOpen=false" @save="save">
      <div class="form-group">
        <label class="form-label">Case Type</label>
...
import { zeroFareRows as seed, caseTypes } from '@/mock/appControlData.js'
...
function save(){ const r=rows.find(x=>x.ID===form.ID); if(r) Object.assign(r, { description:form.description, enabled:form.enabled }); modalOpen.value=false }
</script>
