...
const rows = computed(() => store.zeroFareRows)
...
async function save(){ await store.saveZeroFareRow(form.case_type_id, { description:form.description, enabled:form.enabled }); modalOpen.value=false }
</script>
